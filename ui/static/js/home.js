(function () {
    ...
    function handleGenerateClick() {
        ...
        callGenerateAPI(model, rows).then(function (resp) {
            if (!resp || !Array.isArray(resp.columns) || !Array.isArray(resp.rows)) throw new Error('Server returned unexpected format');
            ...
            if (resultsInfo) resultsInfo.textContent = 'Error: could not generate data. See console for details.';
        });
    }
    function init() {
